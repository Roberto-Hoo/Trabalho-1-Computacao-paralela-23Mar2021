...
LOGICAL, PARAMETER :: debug = .true.    ! <--- Escrever informacoes no modo debug
CHARACTER*1  char1
...
do numLoops = 1, 2000
	if (debug) then
		write(6,'(2x,a,i9)') "NumLoops =  ", numLoops
	end if
	...
	write(20,520)
	write(20,525) Qt_Atualizacoes_u
	...
	write(6,*) '***************************************************************'
	write(6,*) ''
	write(6,*) ' Program  u24h_serial4P.f90'
	write(6,*) ''
	...
	write(6,*) '*******************************************'
	write(6,*) ' Done! Saving data to output files ...'
	write(6,*) '*******************************************'
	write(6,*) ''
	write(6,*) '------------------------------------------------------------'
