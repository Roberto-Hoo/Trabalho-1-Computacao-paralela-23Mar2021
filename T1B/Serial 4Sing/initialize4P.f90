...
! Para escrever informacoes no modo debug, mude para .true.
...
REAL*8   d1, d2, d3, d4 !dist�ncia do pontos (x,y) aos cones
...
DO WHILE ( t < time_next_dump - dt/2D0 )
	...
	! ****************************************************************** !
	! ******  G(i,j) for M1 <= i <= M 2and N1 <= j <= N2 + 1:
...
write(10,520)
write(10,515) Qt_Atualizacoes_u
